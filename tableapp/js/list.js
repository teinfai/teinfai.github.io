...
function GetBooking() {
    let url = 'https://api.sheety.co/2c4974ff237a85e61170436810de54d4/bookingApp/bookings';
    fetch(url)
...
function DeleteBooking(id) {
    let url = 'https://api.sheety.co/2c4974ff237a85e61170436810de54d4/bookingApp/bookings/' + id;
    fetch(url, {
        method: 'DELETE',
    })
        .then(() => {
